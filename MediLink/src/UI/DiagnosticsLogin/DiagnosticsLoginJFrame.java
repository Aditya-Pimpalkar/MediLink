...
public class DiagnosticsLoginJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/images/icons8-ambulance-102.png"))); // NOI18N
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, 120, 120));

        jLabel11.setBackground(new java.awt.Color(54, 125, 118));
        jLabel11.setFont(new java.awt.Font("Arial Black", 1, 20)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("DIAGNOSTICS MANAGEMENT");
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 130, -1, 40));
        ...
        jLabel13.setText("MEDILINK ");
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 370, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/images/icons8-medical-doctor-female-100.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/images/icons8-password-24.png"))); // NOI18N
        jLabel2.setText("jLabel2");
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, 30, 30));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/images/icons8-user-40.png"))); // NOI18N
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 40, -1));
        ...
        userComboBox.setBackground(new java.awt.Color(0, 153, 153));
        userComboBox.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        userComboBox.setBorder(new javax.swing.border.MatteBorder(null));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if("Vendor".equalsIgnoreCase(userType) && (this.applicationSystem.getDiagnosticUserAccountDirectory().getDiagnosticEquipmentVendorsUserDirectory().authenticateUser(userNameField.getText(), passwordField.getText()) != null)){ 
            
            DiagnosticEquipmentVendors vendor = this.applicationSystem.getDiagnosticUserAccountDirectory().getDiagnosticEquipmentVendorsUserDirectory().authenticateUser(userNameField.getText(), passwordField.getText()); 
            foundUser = true;
            vendor.getRole().createWorkArea(applicationSystem, vendor);
            this.setVisible(false); 
        }
        
        if("Diagnosticians".equalsIgnoreCase(userType) && (this.applicationSystem.getDiagnosticUserAccountDirectory().getLabTechniciansUserDirectory().authenticateUser(userNameField.getText(), passwordField.getText()) != null)){ 
            
            LabTechnicians diag = this.applicationSystem.getDiagnosticUserAccountDirectory().getLabTechniciansUserDirectory().authenticateUser(userNameField.getText(), passwordField.getText()); 
            foundUser = true;
