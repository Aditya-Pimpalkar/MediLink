...
public class PharmacyLoginJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/images/icons8-pharma-102.png"))); // NOI18N
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 210, 120, 120));
        ...
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 310, 40));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/UI/images/icons8-login-50.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if("Company".equalsIgnoreCase(userType) && (this.applicationSystem.getPharmacyUserAccountDirectory().getCompaniesDirectory().authenticateUser(userNameField.getText(), passwordField.getText()) != null)){ 
            ...
            Companies comp = (Companies) this.applicationSystem.getPharmacyUserAccountDirectory().getCompaniesDirectory().authenticateUser(userNameField.getText(), passwordField.getText()); 
            foundUser = true;
