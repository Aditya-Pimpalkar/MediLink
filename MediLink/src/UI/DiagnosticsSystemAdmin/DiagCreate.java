...
public class DiagCreate extends javax.swing.JPanel {
    ...
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
        ...
        if(userNameField.getText().isEmpty()||passwordField.getText().isEmpty()){
            ...
            if(this.applicationSystem.getDiagnosticUserAccountDirectory().getLabTechniciansUserDirectory().checkUniqueUsername(userName)){
                     this.applicationSystem.getDiagnosticUserAccountDirectory().getLabTechniciansUserDirectory().createUserAccount(userNameField.getText(), passwordField.getText(), new LabTechniciansRole());
