...
import Ambulance.AmbulanceCoordinator;
...
public class AmbulanceLoginJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 230, 120, 120));
        ...
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 110, 330, 60));
        ...
        jPanel3.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 260, 30, 40));
        ...
        backBtn1.setBorder(new javax.swing.border.MatteBorder(null));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if("poc".equalsIgnoreCase(userType) && (this.applicationSystem.getAmbulanceUserAccountDirectory().getAmbulanceCoordinatorUserDirectory().authenticateUser(userNameField.getText(), passwordField.getText()) != null)){ 
            
            AmbulanceCoordinator ambulanceCoordinator = this.applicationSystem.getAmbulanceUserAccountDirectory().getAmbulanceCoordinatorUserDirectory().authenticateUser(userNameField.getText(), passwordField.getText()); 
            foundUser = true;
            ambulanceCoordinator.getRole().createWorkArea(applicationSystem, ambulanceCoordinator);
            this.setVisible(false); 
        }
