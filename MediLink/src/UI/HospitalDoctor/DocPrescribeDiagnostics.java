...
public class DocPrescribeDiagnostics extends javax.swing.JPanel {
    ...
    public void populateDiagTable(){
        ...
        for(LabTechnicians diag: applicationSystem.getDiagnosticUserAccountDirectory().getLabTechniciansUserDirectory().getUseraccountlist()){
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        LabTechnicians diag = applicationSystem.getDiagnosticUserAccountDirectory().getLabTechniciansUserDirectory().getUseraccountlist().get(diagrow);
