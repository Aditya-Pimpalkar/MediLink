...
public class DiaLendMachines extends javax.swing.JPanel {
    ...
    public void populateTable(){
        ...
        DiagnosticEquipmentVendors vendor= (DiagnosticEquipmentVendors) jComboBox1.getSelectedItem();
    ...
    {
        for(DiagnosticEquipmentVendors vendor : this.applicationSystem.getDiagnosticUserAccountDirectory().getDiagnosticEquipmentVendorsUserDirectory().getUseraccountlist())
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        AssignedMachine am = labTechnicians.getAssignedMachineDirectory().assignedMachine(machine, labTechnicians);
    ...
    private javax.swing.JComboBox<DiagnosticEquipmentVendors> jComboBox1;
