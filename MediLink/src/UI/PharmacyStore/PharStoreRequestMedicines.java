...
public class PharStoreRequestMedicines extends javax.swing.JPanel {
    ...
    {
        for(UserAccount companies : this.applicationSystem.getPharmacyUserAccountDirectory().getCompaniesDirectory().getUseraccountlist())
        {
            this.companyComboBox.addItem((Companies) companies);
        }
    }
    ...
    private void initComponents() {
        ...
        quantityJtextField.setBorder(new javax.swing.border.MatteBorder(null));
